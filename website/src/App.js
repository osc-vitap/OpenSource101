...
function App() {
  ...
  const getapi = () => {
    fetch(
      "https://raw.githubusercontent.com/Open-Source-Community-VIT-AP/OpenSource101/master/.data/complete-data.json"
    )
  ...
  return (
    <div className="App">
      ...
      <a
        href="https://github.com/Open-Source-Community-VIT-AP/OpenSource101"
        target="_blank"
        rel="noreferrer"
      >
        <svg
          ...
          width="143.674"
          height="38.874"
          viewBox="0 0 143.674 38.874"
        >
          <g
            id="Group_67"
            data-name="Group 67"
            transform="translate(-1468.11 -450.911)"
          >
            <rect
              id="Rectangle_493"
